...
DEFAULT_PATH = "C:\\Users\\user\\TheBloke\\Llama-2-13B-GPTQ\\"
...
PATH_TEMPLATE = "C:\\Users\\user\\TheBloke\\{model_name}\\"
...
class ExLLamaLLM(LLM):
    model_name: str = Field("K", alias='model_name')
    model_dir: str = Field("K", alias='model_dir')
    model_path: str = Field("K", alias='model_path')
    tokenizer_path: str = Field("K", alias='tokenizer_path')
    config_path: str = Field("K", alias='config_path')
    ...
    def _get_llm(config_dict):
        ...
        if model_path is None and model_dir != "K":
